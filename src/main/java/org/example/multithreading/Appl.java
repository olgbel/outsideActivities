...
//        for (int i = 0; i < 10; i++) {
//            Auction.Bid bid =  new Auction.Bid((long) i, participants.get(i), prices.get(i));
//            executorService.execute(() -> auction.propose(bid));
//        }
//        executorService.execute(() -> auction.propose(new Auction.Bid(1L, 3L, 550L)));
...
//        ThreadPoolExecutor executor = new ThreadPoolExecutor(8, 8, 1, TimeUnit.SECONDS, new LinkedBlockingQueue<>()) {
//            @Override
//            public void execute(Runnable command) {
//                if (this.getActiveCount() != this.getMaximumPoolSize()) super.execute(command);
//            }
//        };
